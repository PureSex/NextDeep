...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NextDeep', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '🍀生命不息 · 折腾不止🍀', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://nextdeep.net', // 网站地址
  ...
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/@Freedom-wh5jq', // Youtube主页
